...
##Get ice thickness as %
    ...
    p0, = plt.plot(data["DATE"],data["m_20_1_T"], 'b', label="m_20")
    p1, = plt.plot(data["m_23_1_T"], 'm' , label="m_23")
    p2, = plt.plot(data["m_27_1_T"], 'y', label="m_27")
    p3, = plt.plot(data["m_30_1_T"], 'g',label="m_30")

...
folder = (r'C:\Users\Cristian\Desktop\Datasets\GSL Final NW\CSV\03-09')
outputfolder = 'C:\\Users\\Cristian\\Desktop\\Datasets\\GSL Final NW\\CSV\\03-09\\Graphs'
...
##Get ice thickness as %
    ...
    p0, = plt.plot(data["DATE"],data["m_20_Th"], 'b', label="m_20")
    p1, = plt.plot(data["m_23_Th"], 'm' , label="m_23")
    p2, = plt.plot(data["m_27_Th"], 'y', label="m_27")
    p3, = plt.plot(data["m_30_Th"], 'g',label="m_30")

...
# 
# PROGRAM DESCRIPTION:
# Comparison plots with RMSE and MBE estimations of ice cover
# ----------------------------------------------------------------------------
...
filename = r"C:\Users\ReSEC2021\OneDrive - Wilfrid Laurier University\slideanalysis\gbl_icecover.csv"
...
print(x)
p0 = plt.scatter(x2, y, s= 50, label = 'Measured',marker='s',color = 'black')
#p1 = plt.scatter(x2, y1, s = 50, label = 'Simulated',color = 'blue')
p1 = plt.plot(x2, y1,color = 'blue')
...
plt.title('Measured vs Simulated Ice Cover (2009-2020)')
...
#plt.ylim(80,100)
#plt.legend(handles=[p0,p1], bbox_to_anchor=(1.05, 1), loc='upper left', prop=fontP)
